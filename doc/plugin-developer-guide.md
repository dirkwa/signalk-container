...
| `cpuShares`         | `--cpu-shares`         | Soft weight, unset = cgroup `cpu.weight` 100 (an explicit 1024 is weight 39). Only matters under contention. Prefer the plugin's tiers: 5120 high / 512 low / 128 lowest. |
