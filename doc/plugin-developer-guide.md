...
| Use case                                                                                                                                                                                                                                | API                                    | Why                                                                                                                                                                                                                                                                                                                                                                                             |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mount **signalk-container's own data dir** — shared by every managed container — at a chosen container path. Namespace a subdirectory. Rejects a named volume attached to a parent directory, which would expose the whole config tree. | `ContainerConfig.signalkDataMount`     | Declarative — set the container path on the config object, signalk-container resolves the host side. Plugin sees the same string regardless of deployment.                                                                                                                                                                                                                                      |
