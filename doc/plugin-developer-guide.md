...
| Use case                                                                                                                                                                                | API                                    | Why                                                                                                                                                                                                                                                                                                                                                                                             |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mount **signalk-container's own data dir** — shared by every managed container, and mounted whole when backed by a named volume — at a chosen container path. Namespace a subdirectory. | `ContainerConfig.signalkDataMount`     | Declarative — set the container path on the config object, signalk-container resolves the host side. Plugin sees the same string regardless of deployment.                                                                                                                                                                                                                                      |
